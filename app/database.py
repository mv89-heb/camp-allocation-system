...
# Tokens remain available for a later security phase, but absence of tokens must
# never prevent the application or the field-reporting workflow from starting.
